...
extern int dir4[4] = { +1, +WIDTH, -1, -WIDTH };
extern int dir8[8] = { +1, +WIDTH, -1, -WIDTH, +1 + WIDTH, +WIDTH - 1, -1 - WIDTH, -WIDTH + 1 };
extern const int ON = 1;
extern const int OFF = 0;
extern const int DAME = 4;
extern const int ILLEGAL = 5;
extern int ko_z;

#define MAX_MOVES 1000
extern int Record[MAX_MOVES];
extern int moves = 0;

extern int all_playouts = 0;
extern int flag_test_playout = 0;

#define D_MAX 1000
extern int path[D_MAX];
extern int depth;
extern int MoveNum;

extern int check_board[BOARD_MAX];

extern const int FILL_EYE_ERR = 1;
extern const int FILL_EYE_OK = 0;
...
extern NODE NodeArray[NODE_MAX];
extern const int NODE_EMPTY = -1; // no next node
extern const int ILLEGAL_PLACE = -1; // illegal move
extern const int DEPTH_MAX = 1000;
extern int Path[DEPTH_MAX];
extern int NodeNum = 0;
